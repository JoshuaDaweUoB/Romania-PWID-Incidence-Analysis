...
# save
write.csv(hcv_summary_table, "table2_hcv_summary_table.csv", row.names = FALSE)
...
write.csv(hcv_included_table, "tables2_hcv_included_table.csv", row.names = FALSE)
...
# save two-year interval results
write.csv(results_df_two_yearly_rubin_hcv, "table6_results_df_two_yearly_rubin_hcv_rr.csv", row.names = FALSE)
